...
*/var ys,UR;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,y){function T(){}T.prototype=y.prototype,w.D=y.prototype,w.prototype=new T,w.prototype.constructor=w,w.C=function(R,C,b){for(var A=Array(arguments.length-2),je=2;je<arguments.length;je++)A[je-2]=arguments[je];return y.prototype[C].apply(R,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(w,y,T){T||(T=0);var R=Array(16);if(typeof y=="string")for(var C=0;16>C;++C)R[C]=y.charCodeAt(T++)|y.charCodeAt(T++)<<8|y.charCodeAt(T++)<<16|y.charCodeAt(T++)<<24;else for(C=0;16>C;++C)R[C]=y[T++]|y[T++]<<8|y[T++]<<16|y[T++]<<24;y=w.g[0],T=w.g[1],C=w.g[2];var b=w.g[3],A=y+(b^T&(C^b))+R[0]+3614090360&4294967295;y=T+(A<<7&4294967295|A>>>25),A=b+(C^y&(T^C))+R[1]+3905402710&4294967295,b=y+(A<<12&4294967295|A>>>20),A=C+(T^b&(y^T))+R[2]+606105819&4294967295,C=b+(A<<17&4294967295|A>>>15),A=T+(y^C&(b^y))+R[3]+3250441966&4294967295,T=C+(A<<22&4294967295|A>>>10),A=y+(b^T&(C^b))+R[4]+4118548399&4294967295,y=T+(A<<7&4294967295|A>>>25),A=b+(C^y&(T^C))+R[5]+1200080426&4294967295,b=y+(A<<12&4294967295|A>>>20),A=C+(T^b&(y^T))+R[6]+2821735955&4294967295,C=b+(A<<17&4294967295|A>>>15),A=T+(y^C&(b^y))+R[7]+4249261313&4294967295,T=C+(A<<22&4294967295|A>>>10),A=y+(b^T&(C^b))+R[8]+1770035416&4294967295,y=T+(A<<7&4294967295|A>>>25),A=b+(C^y&(T^C))+R[9]+2336552879&4294967295,b=y+(A<<12&4294967295|A>>>20),A=C+(T^b&(y^T))+R[10]+4294925233&4294967295,C=b+(A<<17&4294967295|A>>>15),A=T+(y^C&(b^y))+R[11]+2304563134&4294967295,T=C+(A<<22&4294967295|A>>>10),A=y+(b^T&(C^b))+R[12]+1804603682&4294967295,y=T+(A<<7&4294967295|A>>>25),A=b+(C^y&(T^C))+R[13]+4254626195&4294967295,b=y+(A<<12&4294967295|A>>>20),A=C+(T^b&(y^T))+R[14]+2792965006&4294967295,C=b+(A<<17&4294967295|A>>>15),A=T+(y^C&(b^y))+R[15]+1236535329&4294967295,T=C+(A<<22&4294967295|A>>>10),A=y+(C^b&(T^C))+R[1]+4129170786&4294967295,y=T+(A<<5&4294967295|A>>>27),A=b+(T^C&(y^T))+R[6]+3225465664&4294967295,b=y+(A<<9&4294967295|A>>>23),A=C+(y^T&(b^y))+R[11]+643717713&4294967295,C=b+(A<<14&4294967295|A>>>18),A=T+(b^y&(C^b))+R[0]+3921069994&4294967295,T=C+(A<<20&4294967295|A>>>12),A=y+(C^b&(T^C))+R[5]+3593408605&4294967295,y=T+(A<<5&4294967295|A>>>27),A=b+(T^C&(y^T))+R[10]+38016083&4294967295,b=y+(A<<9&4294967295|A>>>23),A=C+(y^T&(b^y))+R[15]+3634488961&4294967295,C=b+(A<<14&4294967295|A>>>18),A=T+(b^y&(C^b))+R[4]+3889429448&4294967295,T=C+(A<<20&4294967295|A>>>12),A=y+(C^b&(T^C))+R[9]+568446438&4294967295,y=T+(A<<5&4294967295|A>>>27),A=b+(T^C&(y^T))+R[14]+3275163606&4294967295,b=y+(A<<9&4294967295|A>>>23),A=C+(y^T&(b^y))+R[3]+4107603335&4294967295,C=b+(A<<14&4294967295|A>>>18),A=T+(b^y&(C^b))+R[8]+1163531501&4294967295,T=C+(A<<20&4294967295|A>>>12),A=y+(C^b&(T^C))+R[13]+2850285829&4294967295,y=T+(A<<5&4294967295|A>>>27),A=b+(T^C&(y^T))+R[2]+4243563512&4294967295,b=y+(A<<9&4294967295|A>>>23),A=C+(y^T&(b^y))+R[7]+1735328473&4294967295,C=b+(A<<14&4294967295|A>>>18),A=T+(b^y&(C^b))+R[12]+2368359562&4294967295,T=C+(A<<20&4294967295|A>>>12),A=y+(T^C^b)+R[5]+4294588738&4294967295,y=T+(A<<4&4294967295|A>>>28),A=b+(y^T^C)+R[8]+2272392833&4294967295,b=y+(A<<11&4294967295|A>>>21),A=C+(b^y^T)+R[11]+1839030562&4294967295,C=b+(A<<16&4294967295|A>>>16),A=T+(C^b^y)+R[14]+4259657740&4294967295,T=C+(A<<23&4294967295|A>>>9),A=y+(T^C^b)+R[1]+2763975236&4294967295,y=T+(A<<4&4294967295|A>>>28),A=b+(y^T^C)+R[4]+1272893353&4294967295,b=y+(A<<11&4294967295|A>>>21),A=C+(b^y^T)+R[7]+4139469664&4294967295,C=b+(A<<16&4294967295|A>>>16),A=T+(C^b^y)+R[10]+3200236656&4294967295,T=C+(A<<23&4294967295|A>>>9),A=y+(T^C^b)+R[13]+681279174&4294967295,y=T+(A<<4&4294967295|A>>>28),A=b+(y^T^C)+R[0]+3936430074&4294967295,b=y+(A<<11&4294967295|A>>>21),A=C+(b^y^T)+R[3]+3572445317&4294967295,C=b+(A<<16&4294967295|A>>>16),A=T+(C^b^y)+R[6]+76029189&4294967295,T=C+(A<<23&4294967295|A>>>9),A=y+(T^C^b)+R[9]+3654602809&4294967295,y=T+(A<<4&4294967295|A>>>28),A=b+(y^T^C)+R[12]+3873151461&4294967295,b=y+(A<<11&4294967295|A>>>21),A=C+(b^y^T)+R[15]+530742520&4294967295,C=b+(A<<16&4294967295|A>>>16),A=T+(C^b^y)+R[2]+3299628645&4294967295,T=C+(A<<23&4294967295|A>>>9),A=y+(C^(T|~b))+R[0]+4096336452&4294967295,y=T+(A<<6&4294967295|A>>>26),A=b+(T^(y|~C))+R[7]+1126891415&4294967295,b=y+(A<<10&4294967295|A>>>22),A=C+(y^(b|~T))+R[14]+2878612391&4294967295,C=b+(A<<15&4294967295|A>>>17),A=T+(b^(C|~y))+R[5]+4237533241&4294967295,T=C+(A<<21&4294967295|A>>>11),A=y+(C^(T|~b))+R[12]+1700485571&4294967295,y=T+(A<<6&4294967295|A>>>26),A=b+(T^(y|~C))+R[3]+2399980690&4294967295,b=y+(A<<10&4294967295|A>>>22),A=C+(y^(b|~T))+R[10]+4293915773&4294967295,C=b+(A<<15&4294967295|A>>>17),A=T+(b^(C|~y))+R[1]+2240044497&4294967295,T=C+(A<<21&4294967295|A>>>11),A=y+(C^(T|~b))+R[8]+1873313359&4294967295,y=T+(A<<6&4294967295|A>>>26),A=b+(T^(y|~C))+R[15]+4264355552&4294967295,b=y+(A<<10&4294967295|A>>>22),A=C+(y^(b|~T))+R[6]+2734768916&4294967295,C=b+(A<<15&4294967295|A>>>17),A=T+(b^(C|~y))+R[13]+1309151649&4294967295,T=C+(A<<21&4294967295|A>>>11),A=y+(C^(T|~b))+R[4]+4149444226&4294967295,y=T+(A<<6&4294967295|A>>>26),A=b+(T^(y|~C))+R[11]+3174756917&4294967295,b=y+(A<<10&4294967295|A>>>22),A=C+(y^(b|~T))+R[2]+718787259&4294967295,C=b+(A<<15&4294967295|A>>>17),A=T+(b^(C|~y))+R[9]+3951481745&4294967295,w.g[0]=w.g[0]+y&4294967295,w.g[1]=w.g[1]+(C+(A<<21&4294967295|A>>>11))&4294967295,w.g[2]=w.g[2]+C&4294967295,w.g[3]=w.g[3]+b&4294967295}r.prototype.u=function(w,y){y===void 0&&(y=w.length);for(var T=y-this.blockSize,R=this.B,C=this.h,b=0;b<y;){if(C==0)for(;b<=T;)i(this,w,b),b+=this.blockSize;if(typeof w=="string"){for(;b<y;)if(R[C++]=w.charCodeAt(b++),C==this.blockSize){i(this,R),C=0;break}}else for(;b<y;)if(R[C++]=w[b++],C==this.blockSize){i(this,R),C=0;break}}this.h=C,this.o+=y},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var y=1;y<w.length-8;++y)w[y]=0;var T=8*this.o;for(y=w.length-8;y<w.length;++y)w[y]=T&255,T/=256;for(this.u(w),w=Array(16),y=T=0;4>y;++y)for(var R=0;32>R;R+=8)w[T++]=this.g[y]>>>R&255;return w};function s(w,y){var T=a;return Object.prototype.hasOwnProperty.call(T,w)?T[w]:T[w]=y(w)}function o(w,y){this.h=y;for(var T=[],R=!0,C=w.length-1;0<=C;C--){var b=w[C]|0;R&&b==y||(T[C]=b,R=!1)}this.g=T}var a={};function l(w){return-128<=w&&128>w?s(w,function(y){return new o([y|0],0>y?-1:0)}):new o([w|0],0>w?-1:0)}function c(w){if(isNaN(w)||!isFinite(w))return f;if(0>w)return N(c(-w));for(var y=[],T=1,R=0;w>=T;R++)y[R]=w/T|0,T*=4294967296;return new o(y,0)}function d(w,y){if(w.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(w.charAt(0)=="-")return N(d(w.substring(1),y));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var T=c(Math.pow(y,8)),R=f,C=0;C<w.length;C+=8){var b=Math.min(8,w.length-C),A=parseInt(w.substring(C,C+b),y);8>b?(b=c(Math.pow(y,b)),R=R.j(b).add(c(A))):(R=R.j(T),R=R.add(c(A)))}return R}var f=l(0),m=l(1),_=l(16777216);t=o.prototype,t.m=function(){if(k(this))return-N(this).m();for(var w=0,y=1,T=0;T<this.g.length;T++){var R=this.i(T);w+=(0<=R?R:4294967296+R)*y,y*=4294967296}return w},t.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(S(this))return"0";if(k(this))return"-"+N(this).toString(w);for(var y=c(Math.pow(w,6)),T=this,R="";;){var C=x(T,y).g;T=E(T,C.j(y));var b=((0<T.g.length?T.g[0]:T.h)>>>0).toString(w);if(T=C,S(T))return b+R;for(;6>b.length;)b="0"+b;R=b+R}},t.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function S(w){if(w.h!=0)return!1;for(var y=0;y<w.g.length;y++)if(w.g[y]!=0)return!1;return!0}function k(w){return w.h==-1}t.l=function(w){return w=E(this,w),k(w)?-1:S(w)?0:1};function N(w){for(var y=w.g.length,T=[],R=0;R<y;R++)T[R]=~w.g[R];return new o(T,~w.h).add(m)}t.abs=function(){return k(this)?N(this):this},t.add=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0,C=0;C<=y;C++){var b=R+(this.i(C)&65535)+(w.i(C)&65535),A=(b>>>16)+(this.i(C)>>>16)+(w.i(C)>>>16);R=A>>>16,b&=65535,A&=65535,T[C]=A<<16|b}return new o(T,T[T.length-1]&-2147483648?-1:0)};function E(w,y){return w.add(N(y))}t.j=function(w){if(S(this)||S(w))return f;if(k(this))return k(w)?N(this).j(N(w)):N(N(this).j(w));if(k(w))return N(this.j(N(w)));if(0>this.l(_)&&0>w.l(_))return c(this.m()*w.m());for(var y=this.g.length+w.g.length,T=[],R=0;R<2*y;R++)T[R]=0;for(R=0;R<this.g.length;R++)for(var C=0;C<w.g.length;C++){var b=this.i(R)>>>16,A=this.i(R)&65535,je=w.i(C)>>>16,xn=w.i(C)&65535;T[2*R+2*C]+=A*xn,v(T,2*R+2*C),T[2*R+2*C+1]+=b*xn,v(T,2*R+2*C+1),T[2*R+2*C+1]+=A*je,v(T,2*R+2*C+1),T[2*R+2*C+2]+=b*je,v(T,2*R+2*C+2)}for(R=0;R<y;R++)T[R]=T[2*R+1]<<16|T[2*R];for(R=y;R<2*y;R++)T[R]=0;return new o(T,0)};function v(w,y){for(;(w[y]&65535)!=w[y];)w[y+1]+=w[y]>>>16,w[y]&=65535,y++}function I(w,y){this.g=w,this.h=y}function x(w,y){if(S(y))throw Error("division by zero");if(S(w))return new I(f,f);if(k(w))return y=x(N(w),y),new I(N(y.g),N(y.h));if(k(y))return y=x(w,N(y)),new I(N(y.g),y.h);if(30<w.g.length){if(k(w)||k(y))throw Error("slowDivide_ only works with positive integers.");for(var T=m,R=y;0>=R.l(w);)T=F(T),R=F(R);var C=U(T,1),b=U(R,1);for(R=U(R,2),T=U(T,2);!S(R);){var A=b.add(R);0>=A.l(w)&&(C=C.add(T),b=A),R=U(R,1),T=U(T,1)}return y=E(w,C.j(y)),new I(C,y)}for(C=f;0<=w.l(y);){for(T=Math.max(1,Math.floor(w.m()/y.m())),R=Math.ceil(Math.log(T)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),b=c(T),A=b.j(y);k(A)||0<A.l(w);)T-=R,b=c(T),A=b.j(y);S(b)&&(b=m),C=C.add(b),w=E(w,A)}return new I(C,w)}t.A=function(w){return x(this,w).h},t.and=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0;R<y;R++)T[R]=this.i(R)&w.i(R);return new o(T,this.h&w.h)},t.or=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0;R<y;R++)T[R]=this.i(R)|w.i(R);return new o(T,this.h|w.h)},t.xor=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0;R<y;R++)T[R]=this.i(R)^w.i(R);return new o(T,this.h^w.h)};function F(w){for(var y=w.g.length+1,T=[],R=0;R<y;R++)T[R]=w.i(R)<<1|w.i(R-1)>>>31;return new o(T,w.h)}function U(w,y){var T=y>>5;y%=32;for(var R=w.g.length-T,C=[],b=0;b<R;b++)C[b]=0<y?w.i(b+T)>>>y|w.i(b+T+1)<<32-y:w.i(b+T);return new o(C,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,UR=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=d,ys=o}).apply(typeof CE<"u"?CE:typeof self<"u"?self:typeof window<"u"?window:{});var jc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fz="storage-compat";function Uz(t,{instanceIdentifier:e}){const n=t.getProvider("app-compat").getImmediate(),r=t.getProvider("storage").getImmediate({identifier:e});return new WC(n,r)}function jz(t){const e={TaskState:Ut,TaskEvent:dz,StringFormat:Sn,Storage:WC,Reference:Pr};t.INTERNAL.registerComponent(new Cn(Fz,Uz,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),t.registerVersion(Lz,Mz)}jz(Qs);const iv=Qs.initializeApp({apiKey:"AIzaSyAp9XrnMQ2kd-L8I2kVOZJctYBAT-h66tM",authDomain:"polanco-25ef9.firebaseapp.com",projectId:"polanco-25ef9",storageBucket:"polanco-25ef9.appspot.com",messagingSenderId:"804200542961",appId:"1:804200542961:web:010ee2a2d4e45ec098af50"}),sv=fB(iv),Yc=nF(iv),yT=Dz(iv),Sf=O.createContext(),Bz=t=>{const[e,n]=O.useState([]),r=mr(uh(Yc,"inventario"),rk("email","==",localStorage.getItem("userEmailLS"))),i=uh(Yc,"inventario"),[s,o]=O.useState(!0);O.useEffect(()=>{ak(r).then(d=>{d.size===0&&console.log("No results!");const f=d.docs.map(m=>({id:m.id,...m.data()}));n(f)}).catch(d=>{console.log("Error searching items",d)})},[s]);const a=(d,f)=>{const m=_h(yT,`projectFiles/${d==null?void 0:d.name}`);Az(m,d).then(()=>{zC(m).then(_=>{f.imgName=d.name,f.imgUrl=_,uk(i,f),o(!s)})}).catch(_=>console.log(_))},l=async(d,f)=>{const m=fa(Yc,"inventario",d);try{await lk(m);const _=_h(yT,`projectFiles/${f}`);$C(_).then(()=>{console.log(f,"se elimino de Storage")}).catch(S=>{console.log("ocurrio un error: ",S)})}catch(_){console.error(_)}},c=async(d,f)=>{const m=fa(Yc,"inventario",d);try{await cg(m,f)}catch(_){console.error(_)}};return P.jsx(Sf.Provider,{value:{items:e,deleteById:l,UpdateById:c,handleFileAdd:a,postCollection:i,setToggle:o,toggle:s},children:t.children})},zz=({setAuction:t})=>{const{handleFileAdd:e}=O.useContext(Sf),[n,r]=O.useState(),i=R=>new Promise(C=>{yD.imageFileResizer(R,300,300,"JPEG",80,0,b=>{C(b)},"base64")}),s=async R=>{const C=R.target.files[0],b=await i(C);fetch(b).then(A=>A.blob()).then(A=>{const je=new File([A],Date.now()+".jpeg",{type:"image/jpeg"});r(je)})},[o,a]=O.useState(!1),[l,c]=O.useState(""),d=O.useRef(),f=O.useRef(),m=O.useRef(),_=O.useRef(),S=O.useRef(),k=O.useRef(),N=O.useRef(),E=O.useRef(),v=O.useRef(),I=O.useRef(),x=O.useRef(),F=O.useRef(),U=()=>a(!0),w=()=>a(!1),y=["image/png","image/jpeg","image/jpg"],T=async R=>{var je;if(R.preventDefault(),c(""),!y.includes((je=k.current)==null?void 0:je.files[0].type))return c("por favor use una imagen valida (png, jpeg, jpg)");let C=new Date,b=C.setHours(C.getHours()),A={email:localStorage.getItem("userEmailLS"),name:d.current.value,para:f.current.value,category:m.current.value,price:Number(_.current.value),marca:S.current.value,duration:b,color:E.current.value,tela:v.current.value,stockHermosillo:Number(I.current.value),talla:N.current.value,stockSanCarlos:Number(x.current.value),description:F.current.value};e(n,A),w()};return P.jsxs(P.Fragment,{children:[P.jsx("div",{className:"col d-flex justify-content-center my-3 ",children:P.jsx("div",{onClick:U,className:"btn btn-primary mx-5",children:"CREAR INFORME"})}),P.jsx(cn,{centered:!0,show:o,onHide:w,style:{width:"96%",marginLeft:"1%"},children:P.jsxs("form",{onSubmit:T,style:{backgroundColor:"rgb(222,222,222)"},children:[P.jsxs(cn.Body,{children:[l&&P.jsx(KS,{variant:"danger",children:l}),P.jsx(Kt,{children:P.jsx(Vt,{className:"border mb-5 btn bg-primary mx-2 p-2 text-center text-white",children:localStorage.getItem("userEmailLS")})}),P.jsx(Kt,{children:P.jsxs(Vt,{children:[P.jsx(te.Label,{children:"Imagen"}),P.jsx(te.Group,{children:P.jsx(te.Control,{type:"file",label:"Cargar Foto",required:!0,ref:k,onChange:s})})]})}),P.jsx("hr",{}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Nombre"}),P.jsx(te.Control,{type:"text",required:!0,ref:d})]})})}),P.jsx(Kt,{children:P.jsxs(Vt,{className:"mb-2",children:[P.jsx(te.Label,{children:"para"}),P.jsxs(te.Control,{as:"select",multiple:!1,ref:f,children:[P.jsx("option",{value:"hombre",children:"Hombre"}),P.jsx("option",{value:"mujer",children:"Mujer"})]})]})}),P.jsx(Kt,{children:P.jsxs(Vt,{className:"mb-2",children:[P.jsx(te.Label,{children:"Categoria"}),P.jsxs(te.Control,{as:"select",multiple:!1,ref:m,children:[P.jsx("option",{value:"color",children:"color"}),P.jsx("option",{value:"blanco",children:"blanco"})]})]})}),P.jsx(Kt,{children:P.jsxs(Vt,{children:[P.jsx(te.Label,{children:"talla"}),P.jsx(te.Control,{type:"text",required:!0,ref:N})]})}),P.jsx("hr",{}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"marca"}),P.jsx(te.Control,{type:"text",required:!0,ref:S})]})})}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"precio"}),P.jsx(te.Control,{type:"number",required:!0,ref:_})]})})}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Color"}),P.jsx(te.Control,{type:"text",required:!0,ref:E})]})})}),P.jsx(Kt,{children:P.jsxs(Vt,{className:"mb-2",children:[P.jsx(te.Label,{children:"tela"}),P.jsxs(te.Control,{as:"select",multiple:!1,ref:v,children:[P.jsx("option",{value:"algodon",children:"algodon"}),P.jsx("option",{value:"lino",children:"lino"})]})]})}),P.jsx("hr",{}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Stock Hermosillo"}),P.jsx(te.Control,{type:"number",required:!0,ref:I})]})})}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Stock San Carlos"}),P.jsx(te.Control,{type:"number",required:!0,ref:x})]})})}),P.jsx(Kt,{children:P.jsx(Vt,{children:P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Descripcion"}),P.jsx(te.Control,{type:"text",required:!0,ref:F})]})})})]}),P.jsxs(cn.Footer,{children:[P.jsx(Ps,{variant:"secondary",onClick:w,children:"Cancelar"}),P.jsx(Ps,{variant:"primary",disabled:!1,type:"submit",children:"Guardar"})]})]})})]})},$z=({item:t})=>{const{deleteById:e,setToggle:n,toggle:r}=O.useContext(Sf);return P.jsxs("div",{className:"card shadow-sm ",children:[P.jsx("div",{style:{height:"180px",backgroundImage:`url(${t.imgUrl})`,backgroundSize:"contain",backgroundRepeat:"no-repeat",backgroundPosition:"center"},className:"w-100 mt-4"}),P.jsxs("div",{className:"card-body p-4 ",children:[P.jsx("h5",{children:" "}),P.jsx("hr",{}),P.jsxs("p",{children:["Nombre: ",t.name]}),P.jsxs("p",{children:["para: ",t.para]}),P.jsxs("p",{children:[" categoria: ",t.category]}),P.jsxs("p",{children:[" precio: ",t.price]}),P.jsx("hr",{}),P.jsxs("p",{children:[" marca: ",t.marca]}),P.jsxs("p",{children:[" talla: ",t.talla]}),P.jsxs("p",{children:[" color: ",t.color]}),P.jsxs("p",{children:[" tela: ",t.tela]}),P.jsxs("p",{children:[" stock hermosillo: ",t.stockHermosillo]}),P.jsx("hr",{}),P.jsxs("p",{children:[" stock San Carlos: ",t.stockSanCarlos]}),P.jsxs("p",{children:[" Descripcion ",t.description]}),P.jsx("hr",{}),P.jsx("div",{className:"btnBorrarInforme",children:P.jsx("button",{className:"btn btn-danger",onClick:()=>{window.confirm(`Quiere Borrar este Documento? ${t.imgName}`)&&(e(t.id,t.imgName),n(!r))},children:"Borrar"})})]})]})},rc=O.createContext(),qz=t=>{const e=async(o,a,l)=>{try{await Uk(o,a,l),i(o,a,l)}catch(c){console.error("code.error",c.code);const d={"auth/email-already-in-use":()=>alert("El Correo ya esta en Uso"),"auth/operation-not-allowed":()=>alert("Operacion No Permitida."),"auth/weak-password":()=>alert("La contraseña es muy débil."),"auth/invalid-email":()=>alert("El Correo No es Valido")};(m=>{d[m]()})(c.code)}},[n,r]=O.useState(!0),i=(o,a,l)=>{jk(o,a,l).then(c=>{const d=c.user;localStorage.setItem("userEmailLS",d.email),r(!n),location.reload()}).catch(c=>{console.log(c.code),console.log(c.message),c.code=="auth/invalid-credential"&&alert("Contraseña o Correo son Incorrrectos")})},s=()=>{bU(sv),localStorage.removeItem("userEmailLS"),r(!n)};return P.jsx(rc.Provider,{value:{register:e,login:i,logout:s,stateLogout:n},children:t.children})},Wz=()=>{const{items:t}=O.useContext(Sf),{stateLogout:e}=O.useContext(rc);return console.log(t),P.jsxs("div",{className:"",children:[localStorage.getItem("userEmailLS")!==null&&P.jsx(zz,{}),e?P.jsx("div",{className:"row row-cols-1 row-cols-md-3 row-cols-lg-4 p-5 g-3 border mt-1 ",children:t.map((n,r)=>P.jsx($z,{item:n},r))}):""]})},Gz="https://xipeRafa.github.io/inventarioPolanco/assets/canal10-BlZAdtVJ.png",Hz=()=>{const{login:t}=O.useContext(rc),[e,n]=O.useState(!1),r=O.useRef(),i=O.useRef(),s=()=>n(!0),o=()=>n(!1),a=l=>{l.preventDefault(),localStorage.removeItem("Done"),t(sv,r.current.value,i.current.value),o()};return P.jsxs(P.Fragment,{children:[P.jsx("div",{onClick:s,className:"btn btn-outline-secondary mx-2",children:"Entrar"}),P.jsx(cn,{centered:!0,show:e,onHide:o,children:P.jsxs("form",{onSubmit:a,children:[P.jsx(cn.Header,{children:P.jsx(cn.Title,{children:"Entrar"})}),P.jsxs(cn.Body,{children:[P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Email "}),P.jsx(te.Control,{type:"email",required:!0,ref:r})]}),P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Password"}),P.jsx(te.Control,{type:"password",required:!0,ref:i})]})]}),P.jsxs(cn.Footer,{children:[P.jsx(Ps,{variant:"secondary",onClick:o,children:" Cancelar "}),P.jsx(Ps,{variant:"primary",type:"submit",children:"         Entrar "})]})]})})]})},Kz=()=>{const{register:t}=O.useContext(rc),[e,n]=O.useState(!1),[r,i]=O.useState(""),s=O.useRef(),o=O.useRef(),a=O.useRef(),l=()=>n(!0),c=()=>{i(""),n(!1)},d=async f=>{if(f.preventDefault(),i(""),o.current.value!==a.current.value)return i("Claves No son iguales.");if(o.current.value.length<6)return i("Claves es muy corta Use 6 caracteres Minimo");t(sv,s.current.value,o.current.value),c()};return P.jsxs(P.Fragment,{children:[P.jsx("div",{onClick:l,className:"btn btn-outline-secondary mx-2",children:"Registro"}),P.jsx(cn,{centered:!0,show:e,onHide:c,children:P.jsxs("form",{onSubmit:d,children:[P.jsx(cn.Header,{children:P.jsx(cn.Title,{children:"Registro"})}),P.jsxs(cn.Body,{children:[r&&P.jsx(KS,{variant:"danger",children:r}),P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Email"}),P.jsx(te.Control,{type:"email",required:!0,ref:s})]}),P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Password"}),P.jsx(te.Control,{type:"password",required:!0,ref:o})]}),P.jsxs(te.Group,{children:[P.jsx(te.Label,{children:"Confirmar Password"}),P.jsx(te.Control,{type:"password",required:!0,ref:a})]})]}),P.jsxs(cn.Footer,{children:[P.jsx(Ps,{variant:"secondary",onClick:c,children:" Cancelar "}),P.jsx(Ps,{variant:"primary",type:"submit",children:" Registro "})]})]})})]})},Qz=()=>{const{logout:t,stateLogout:e}=O.useContext(rc);return P.jsxs("nav",{className:"container navbar navbar-light",children:[P.jsx("div",{className:"w-100 d-flex justify-content-center",children:P.jsx("div",{className:"navbar-brand mb-4",children:P.jsx("img",{src:Gz,alt:"logo",height:"140"})})}),P.jsx("div",{className:"w-100 d-flex justify-content-center",children:P.jsx("div",{className:"mb-4",children:localStorage.getItem("userEmailLS")!==null?P.jsxs(P.Fragment,{children:[P.jsx("div",{className:"btn btn-secondary mx-2 disabled",children:localStorage.getItem("userEmailLS")}),P.jsx("div",{onClick:()=>{window.confirm("Quieres Salir?")&&t()},className:"btn btn-outline-secondary mx-2",children:"SALIR"})]}):P.jsxs(P.Fragment,{children:[P.jsx(Hz,{}),P.jsx(Kz,{})]})})})]})},Yz=()=>P.jsx(P.Fragment,{children:P.jsx(qz,{children:P.jsxs(Bz,{children:[P.jsx(Qz,{}),P.jsx(Wz,{})]})})});Fp.createRoot(document.getElementById("root")).render(P.jsx(oi.StrictMode,{children:P.jsx(Yz,{})}));
