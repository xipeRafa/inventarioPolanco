 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fz="storage-compat";function Uz(t,{instanceIdentifier:e}){const n=t.getProvider("app-compat").getImmediate(),r=t.getProvider("storage").getImmediate({identifier:e});return new WC(n,r)}function jz(t){const e={TaskState:Ft,TaskEvent:dz,StringFormat:Sn,Storage:WC,Reference:Pr};t.INTERNAL.registerComponent(new Cn(Fz,Uz,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),t.registerVersion(Lz,Mz)}jz(Qs);const iv=Qs.initializeApp({apiKey:"AIzaSyAp9XrnMQ2kd-L8I2kVOZJctYBAT-h66tM",authDomain:"polanco-25ef9.firebaseapp.com",projectId:"polanco-25ef9",storageBucket:"polanco-25ef9.appspot.com",messagingSenderId:"804200542961",appId:"1:804200542961:web:010ee2a2d4e45ec098af50"}),sv=fB(iv),Yc=nF(iv),yT=Dz(iv),Sf=O.createContext(),Bz=t=>{const[e,n]=O.useState([]),r=mr(uh(Yc,"inventario"),rk("email","==",localStorage.getItem("userEmailLS"))),i=uh(Yc,"inventario"),[s,o]=O.useState(!0);O.useEffect(()=>{ak(r).then(d=>{d.size===0&&console.log("No results!");const f=d.docs.map(m=>({id:m.id,...m.data()}));n(f)}).catch(d=>{console.log("Error searching items",d)})},[s]);const a=(d,f)=>{const m=_h(yT,`projectFiles/${d==null?void 0:d.name}`);Az(m,d).then(()=>{zC(m).then(_=>{f.imgName=d.name,f.imgUrl=_,uk(i,f),o(!s)})}).catch(_=>console.log(_))},l=async(d,f)=>{const m=fa(Yc,"inventario",d);try{await lk(m);const _=_h(yT,`projectFiles/${f}`);$C(_).then(()=>{console.log(f,"se elimino de Storage")}).catch(S=>{console.log("ocurrio un error: ",S)})}catch(_){console.error(_)}},c=async(d,f)=>{const m=fa(Yc,"inventario",d);try{await cg(m,f)}catch(_){console.error(_)}};return R.jsx(Sf.Provider,{value:{items:e,deleteById:l,UpdateById:c,handleFileAdd:a,postCollection:i,setToggle:o,toggle:s},children:t.children})},zz=({setAuction:t})=>{const{handleFileAdd:e}=O.useContext(Sf),[n,r]=O.useState(),i=T=>new Promise(A=>{yD.imageFileResizer(T,300,300,"JPEG",80,0,C=>{A(C)},"base64")}),s=async T=>{const A=T.target.files[0],C=await i(A);fetch(C).then(b=>b.blob()).then(b=>{const P=new File([b],Date.now()+".jpeg",{type:"image/jpeg"});r(P)})},[o,a]=O.useState(!1),[l,c]=O.useState(""),d=O.useRef(),f=O.useRef(),m=O.useRef(),_=O.useRef(),S=O.useRef(),k=O.useRef(),N=O.useRef(),E=O.useRef(),v=O.useRef(),I=O.useRef(),x=O.useRef(),F=()=>a(!0),U=()=>a(!1),w=["image/png","image/jpeg","image/jpg"],y=async T=>{var P;if(T.preventDefault(),c(""),!w.includes((P=k.current)==null?void 0:P.files[0].type))return c("por favor use una imagen valida (png, jpeg, jpg)");let A=new Date,C=A.setHours(A.getHours()),b={email:localStorage.getItem("userEmailLS"),name:d.current.value,para:f.current.value,category:m.current.value,price:Number(_.current.value),marca:S.current.value,duration:C,color:E.current.value,tela:v.current.value,stockHermosillo:Number(I.current.value),talla:N.current.value,sucursal:"Hermosillo",description:x.current.value};e(n,b),U()};return R.jsxs(R.Fragment,{children:[R.jsx("div",{className:"col d-flex justify-content-center my-3 ",children:R.jsx("div",{onClick:F,className:"btn btn-primary mx-5",children:"CREAR INFORME"})}),R.jsx(cn,{centered:!0,show:o,onHide:U,style:{width:"96%",marginLeft:"1%"},children:R.jsxs("form",{onSubmit:y,style:{backgroundColor:"rgb(222,222,222)"},children:[R.jsxs(cn.Body,{children:[l&&R.jsx(KS,{variant:"danger",children:l}),R.jsx(an,{children:R.jsx(Ht,{className:"border mb-5 btn bg-primary mx-2 p-2 text-center text-white",children:localStorage.getItem("userEmailLS")})}),R.jsx(an,{children:R.jsxs(Ht,{children:[R.jsx(ne.Label,{children:"Imagen"}),R.jsx(ne.Group,{children:R.jsx(ne.Control,{type:"file",label:"Cargar Foto",required:!0,ref:k,onChange:s})})]})}),R.jsx("hr",{}),R.jsx(an,{children:R.jsx(Ht,{children:R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Nombre"}),R.jsx(ne.Control,{type:"text",required:!0,ref:d})]})})}),R.jsx(an,{children:R.jsxs(Ht,{className:"mb-2",children:[R.jsx(ne.Label,{children:"para"}),R.jsxs(ne.Control,{as:"select",multiple:!1,ref:f,children:[R.jsx("option",{value:"hombre",children:"Hombre"}),R.jsx("option",{value:"mujer",children:"Mujer"})]})]})}),R.jsx(an,{children:R.jsxs(Ht,{className:"mb-2",children:[R.jsx(ne.Label,{children:"Categoria"}),R.jsxs(ne.Control,{as:"select",multiple:!1,ref:m,children:[R.jsx("option",{value:"color",children:"color"}),R.jsx("option",{value:"blanco",children:"blanco"})]})]})}),R.jsx(an,{children:R.jsxs(Ht,{children:[R.jsx(ne.Label,{children:"talla"}),R.jsx(ne.Control,{type:"text",required:!0,ref:N})]})}),R.jsx("hr",{}),R.jsx(an,{children:R.jsx(Ht,{children:R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"marca"}),R.jsx(ne.Control,{type:"text",required:!0,ref:S})]})})}),R.jsx(an,{children:R.jsx(Ht,{children:R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"precio"}),R.jsx(ne.Control,{type:"number",required:!0,ref:_})]})})}),R.jsx(an,{children:R.jsx(Ht,{children:R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Color"}),R.jsx(ne.Control,{type:"text",required:!0,ref:E})]})})}),R.jsx(an,{children:R.jsxs(Ht,{className:"mb-2",children:[R.jsx(ne.Label,{children:"tela"}),R.jsxs(ne.Control,{as:"select",multiple:!1,ref:v,children:[R.jsx("option",{value:"algodon",children:"algodon"}),R.jsx("option",{value:"lino",children:"lino"})]})]})}),R.jsx("hr",{}),R.jsx(an,{children:R.jsx(Ht,{children:R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Stock Hermosillo"}),R.jsx(ne.Control,{type:"number",required:!0,ref:I})]})})}),R.jsx(an,{children:R.jsx(Ht,{children:R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Descripcion"}),R.jsx(ne.Control,{type:"text",required:!0,ref:x})]})})})]}),R.jsxs(cn.Footer,{children:[R.jsx(Ps,{variant:"secondary",onClick:U,children:"Cancelar"}),R.jsx(Ps,{variant:"primary",disabled:!1,type:"submit",children:"Guardar"})]})]})})]})},$z=({item:t})=>{const e=new Intl.DateTimeFormat("es-MX",{dateStyle:"long",timeStyle:"short"}),n=a=>e.format(new Date(a)),{deleteById:r,setToggle:i,toggle:s}=O.useContext(Sf);function o(){let c=qrcode(26,"L");return c.addData(`https://xiperafa.github.io/polancoEcommerc/item/${t.id}`),c.make(),R.jsx("div",{dangerouslySetInnerHTML:{__html:c.createImgTag()}})}return R.jsxs("div",{className:"card shadow-sm ",onClick:()=>qrFunction(),children:[R.jsx("div",{style:{height:"180px",backgroundImage:`url(${t.imgUrl})`,backgroundSize:"contain",backgroundRepeat:"no-repeat",backgroundPosition:"center"},className:"w-100 mt-4"}),R.jsxs("div",{className:"card-body p-4 ",children:[R.jsxs("p",{children:[" ",n(t.duration),"  "]}),R.jsx("hr",{}),R.jsxs("p",{children:["Nombre: ",R.jsx("span",{children:t.name})]}),R.jsxs("p",{children:["para: ",R.jsx("span",{children:t.para})]}),R.jsxs("p",{children:[" categoria: ",R.jsx("span",{children:t.category})]}),R.jsxs("p",{children:[" precio: ",R.jsx("span",{children:t.price})]}),R.jsx("hr",{}),R.jsxs("p",{children:[" marca: ",R.jsx("span",{children:t.marca})]}),R.jsxs("p",{children:[" talla: ",R.jsx("span",{children:t.talla})]}),R.jsxs("p",{children:[" color: ",R.jsx("span",{children:t.color})]}),R.jsxs("p",{children:[" tela: ",R.jsx("span",{children:t.tela})]}),R.jsxs("p",{children:[" stock hermosillo: ",R.jsx("span",{children:t.stockHermosillo})]}),R.jsx("hr",{}),R.jsxs("p",{children:[" Descripcion ",R.jsx("span",{children:t.description})]}),R.jsx("hr",{}),R.jsx("div",{className:"btnBorrarInforme",children:R.jsx("button",{className:"btn btn-danger",onClick:()=>{window.confirm(`Quiere Borrar este Documento? ${t.name}`)&&(r(t.id,t.imgName),i(!s))},children:"Borrar"})})]}),R.jsx(o,{})]})},rc=O.createContext(),qz=t=>{const e=async(o,a,l)=>{try{await Uk(o,a,l),i(o,a,l)}catch(c){console.error("code.error",c.code);const d={"auth/email-already-in-use":()=>alert("El Correo ya esta en Uso"),"auth/operation-not-allowed":()=>alert("Operacion No Permitida."),"auth/weak-password":()=>alert("La contraseña es muy débil."),"auth/invalid-email":()=>alert("El Correo No es Valido")};(m=>{d[m]()})(c.code)}},[n,r]=O.useState(!0),i=(o,a,l)=>{jk(o,a,l).then(c=>{const d=c.user;localStorage.setItem("userEmailLS",d.email),r(!n),location.reload()}).catch(c=>{console.log(c.code),console.log(c.message),c.code=="auth/invalid-credential"&&alert("Contraseña o Correo son Incorrrectos")})},s=()=>{bU(sv),localStorage.removeItem("userEmailLS"),r(!n)};return R.jsx(rc.Provider,{value:{register:e,login:i,logout:s,stateLogout:n},children:t.children})},Wz=()=>{const{items:t}=O.useContext(Sf),{stateLogout:e}=O.useContext(rc);return console.log(t),R.jsxs("div",{className:"",children:[localStorage.getItem("userEmailLS")!==null&&R.jsx(zz,{}),e?R.jsx("div",{className:"row row-cols-1 row-cols-md-3 row-cols-lg-4 p-5 g-3 border mt-1 ",children:t.sort((n,r)=>r.duration-n.duration).filter(n=>n.sucursal==="Hermosillo").map((n,r)=>R.jsx($z,{item:n},r))}):""]})},Gz="https://xipeRafa.github.io/inventarioPolanco/assets/canal10-BlZAdtVJ.png",Hz=()=>{const{login:t}=O.useContext(rc),[e,n]=O.useState(!1),r=O.useRef(),i=O.useRef(),s=()=>n(!0),o=()=>n(!1),a=l=>{l.preventDefault(),localStorage.removeItem("Done"),t(sv,r.current.value,i.current.value),o()};return R.jsxs(R.Fragment,{children:[R.jsx("div",{onClick:s,className:"btn btn-outline-secondary mx-2",children:"Entrar"}),R.jsx(cn,{centered:!0,show:e,onHide:o,children:R.jsxs("form",{onSubmit:a,children:[R.jsx(cn.Header,{children:R.jsx(cn.Title,{children:"Entrar"})}),R.jsxs(cn.Body,{children:[R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Email "}),R.jsx(ne.Control,{type:"email",required:!0,ref:r})]}),R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Password"}),R.jsx(ne.Control,{type:"password",required:!0,ref:i})]})]}),R.jsxs(cn.Footer,{children:[R.jsx(Ps,{variant:"secondary",onClick:o,children:" Cancelar "}),R.jsx(Ps,{variant:"primary",type:"submit",children:"         Entrar "})]})]})})]})},Kz=()=>{const{register:t}=O.useContext(rc),[e,n]=O.useState(!1),[r,i]=O.useState(""),s=O.useRef(),o=O.useRef(),a=O.useRef(),l=()=>n(!0),c=()=>{i(""),n(!1)},d=async f=>{if(f.preventDefault(),i(""),o.current.value!==a.current.value)return i("Claves No son iguales.");if(o.current.value.length<6)return i("Claves es muy corta Use 6 caracteres Minimo");t(sv,s.current.value,o.current.value),c()};return R.jsxs(R.Fragment,{children:[R.jsx("div",{onClick:l,className:"btn btn-outline-secondary mx-2",children:"Registro"}),R.jsx(cn,{centered:!0,show:e,onHide:c,children:R.jsxs("form",{onSubmit:d,children:[R.jsx(cn.Header,{children:R.jsx(cn.Title,{children:"Registro"})}),R.jsxs(cn.Body,{children:[r&&R.jsx(KS,{variant:"danger",children:r}),R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Email"}),R.jsx(ne.Control,{type:"email",required:!0,ref:s})]}),R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Password"}),R.jsx(ne.Control,{type:"password",required:!0,ref:o})]}),R.jsxs(ne.Group,{children:[R.jsx(ne.Label,{children:"Confirmar Password"}),R.jsx(ne.Control,{type:"password",required:!0,ref:a})]})]}),R.jsxs(cn.Footer,{children:[R.jsx(Ps,{variant:"secondary",onClick:c,children:" Cancelar "}),R.jsx(Ps,{variant:"primary",type:"submit",children:" Registro "})]})]})})]})},Qz=()=>{const{logout:t,stateLogout:e}=O.useContext(rc);return R.jsxs("nav",{className:"container navbar navbar-light",children:[R.jsx("div",{className:"w-100 d-flex justify-content-center",children:R.jsx("div",{className:"navbar-brand mb-4",children:R.jsx("img",{src:Gz,alt:"logo",height:"140"})})}),R.jsx("div",{className:"w-100 d-flex justify-content-center",children:R.jsx("div",{className:"mb-4",children:localStorage.getItem("userEmailLS")!==null?R.jsxs(R.Fragment,{children:[R.jsx("div",{className:"btn btn-secondary mx-2 disabled",children:R.jsx("b",{children:"HERMOSILLO"})}),R.jsx("div",{onClick:()=>{window.confirm("Quieres Salir?")&&t()},className:"btn btn-outline-secondary mx-2",children:"SALIR"})]}):R.jsxs(R.Fragment,{children:[R.jsx(Hz,{}),R.jsx(Kz,{})]})})})]})},Yz=()=>R.jsx(R.Fragment,{children:R.jsx(qz,{children:R.jsxs(Bz,{children:[R.jsx(Qz,{}),R.jsx(Wz,{})]})})});Fp.createRoot(document.getElementById("root")).render(R.jsx(oi.StrictMode,{children:R.jsx(Yz,{})}));
